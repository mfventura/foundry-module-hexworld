...
- **Layer visibility switches**: toggle labels, realm frontiers, sites & POIs, roads and rivers independently (scene HUD and generator toolbar) to declutter the view — client-local and purely visual, the data stays untouched.
