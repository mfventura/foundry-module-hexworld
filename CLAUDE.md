...
- Los controles de escena (`getSceneControlButtons`, formato record de v13+) solo aparecen para GM en escenas con flags v2. HUD de radio/fuerza: `canvas/brush-hud.js` (AppV2 sin frame), abierto en `_activate`.
